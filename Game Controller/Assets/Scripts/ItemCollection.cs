...
public class ItemCollection : MonoBehaviour
{
    ...
    void MakeDish(HashSet<string> recipe)
    {
        ...
        Ball.GetComponent<PlayerController>().Speed = Mathf.Min(Ball.GetComponent<PlayerController>().Speed + CoinScript.speedDecreaseRatioToWeight * earnedPoints,
                                                                Ball.GetComponent<PlayerController>().MaxSpeedThreshold);
    }
